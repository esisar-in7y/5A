...
public class DataSource {
	...
	private static String[] prenomHomme = { "Acton", "Erasmus", "Guy", "Tyrone", "Caldwell", "Gregory", "Quinlan",
			"Leroy", "Brody", "Ulysses", "Branden", "Kermit", "Daquan", "Richard", "Graiden", "Armando", "Gannon",
			"Armando", "Basil", "Declan", "Harding", "Rafael", "Conan", "Lyle", "Phillip", "Christopher", "Malcolm",
			"Aristotle", "Christian", "Dane", "Kaseem", "Jackson", "Neil", "Leo", "Channing", "Gage", "Lev", "Tarik",
			"Amery", "Randall", "Timon", "Bruce", "Uriah", "Coby", "Hilel", "Valentine", "Kareem", "Leonard", "Brady",
			"Branden", "Duncan", "Jordan", "Dylan", "Ryan", "Isaac", "Wayne", "Eaton", "Orlando", "Cadman", "Abraham",
			"Bert", "Alexander", "Troy", "Alden", "Kibo", "Palmer", "Oscar", "Ian", "Dalton", "Shad", "Tobias", "Kirk",
			"Quamar", "Kermit", "Dexter", "Dale", "Gavin", "Abel", "Emery", "Armand", "Garth", "Porter", "Kane",
			"Jarrod", "Odysseus", "Norman", "Amos", "Geoffrey", "Rogan", "Justin", "Stephen", "Branden", "Malcolm",
			"Derek", "Blake", "Laith", "Denton", "Carson", "Brenden", "Cruz" };

	private static String[] prenomFemme = { "Xaviera", "Vivien", "Shoshana", "Marny", "Evelyn", "Kaden", "Nyssa",
			"Victoria", "Karleigh", "Petra", "Riley", "Tashya", "Ingrid", "Courtney", "Danielle", "Tanya", "Basia",
			"Daria", "Eleanor", "Winifred", "Ifeoma", "Teegan", "Stephanie", "Summer", "Shelby", "Melodie", "Alexa",
			"Mercedes", "Xena", "Pamela", "Maisie", "Nichole", "Brynne", "Shea", "Hillary", "Mikayla", "Lana", "Karen",
			"Jayme", "Kai", "Kameko", "Mechelle", "Evangeline", "Gwendolyn", "Suki", "Fleur", "Jamalia", "Fleur",
			"Shoshana", "Amity", "Debra", "Guinevere", "Marah", "Gemma", "Quincy", "Fallon", "Halla", "Nerea", "Diana",
			"Amaya", "Maite", "Bryar", "Raven", "Maisie", "Meredith", "Xyla", "Avye", "Lysandra", "Chanda", "Cassandra",
			"Stephanie", "Jessamine", "Cherokee", "Whoopi", "Molly", "Maryam", "Stacey", "Venus", "Wanda", "Ria",
			"Maryam", "Jillian", "Fay", "Rhea", "Nayda", "Diana", "Whilemina", "Camilla", "Portia", "Laurel", "Neve",
			"Olympia", "Emi", "Echo", "Madison", "Yuri", "Winter", "Pamela", "Claudia", "Maya" };

	private static String[] nomFamille = { "DUNLAP", "JUAREZ", "WILKERSON", "STEIN", "LEON", "BUCKLEY", "BLAIR",
			"REESE", "WHITAKER", "HARRINGTON", "BOYLE", "HALE", "HARPER", "NUNEZ", "HANSEN", "DANIEL", "WEBB",
			"PITTMAN", "RHODES", "ROSE", "ROBERTSON", "RUSSO", "MCCLAIN", "KERR", "BURRIS", "BARTLETT", "FREDERICK",
			"AYERS", "GOODMAN", "NIXON", "FITZPATRICK", "RIVERA", "STONE", "BOND", "WHITLEY", "HOOPER", "HARMON",
			"KELLY", "HOFFMAN", "TERRY", "PRINCE", "FULLER", "DELEON", "SULLIVAN", "MONROE", "GRANT", "SANDOVAL",
			"LAWSON", "GARRISON", "SANDERS", "CONRAD", "PRUITT", "DRAKE", "MCCALL", "HANSEN", "PITTMAN", "CUMMINGS",
			"TERRELL", "REYES", "OCONNOR", "HUBER", "CROSBY", "DICKERSON", "COX", "SALAZAR", "KELLEY", "SUMMERS",
			"PATTERSON", "HOLMES", "BURRIS", "CUMMINGS", "SLOAN", "WOLF", "OSBORN", "MOONEY", "HARMON", "MCBRIDE",
			"MCCARTY", "MCKAY", "MARTIN", "HOUSTON", "CARVER", "GORDON", "HERMAN", "WALL", "FITZPATRICK", "OCONNOR",
			"HUBBARD", "GILL", "RUIZ", "CHAN", "SHERMAN", "ROBERTS", "HUBBARD", "WATTS", "NUNEZ", "MACIAS", "AGUILAR",
			"BLAIR", "GROSS" };
	...
	private void loadDepartementAndRegion() {
		...
		departements
				.add(new Departement("Alpes de Haute-Provence", 4, getOrCreateRegion("Provence-Alpes-Côte d'Azur")));
	...
	public static void main(String[] args) {
		/*
		 * List<Client> clis = DataSource.getDataSource().getClients(); for (Client
		 * client : clis) {
		 * System.out.println("cli "+client.nom+" "+client.prenom+" "+client.numTel+" ("
		 * +client.departement.numero+","+client.departement.nom+")"); }
		 */
		...
		for (Departement departement : depts) {
			System.out.println("dept = " + departement.nom + " nb Appel = "
					+ DataSource.getDataSource().getDepartementNbAppel(departement.numero));
		}
